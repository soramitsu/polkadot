...
class REITest : public ::testing::Test {
 ...
 protected:
  ...
  const std::string wasm_template_ =
      ...
      "  (import \"env\" \"ext_start_batch_verify\" (func $ext_crypto_start_batch_verify_version_1 (type 11)))\n"
      "  (import \"env\" \"ext_finish_batch_verify\" (func $ext_crypto_finish_batch_verify_version_1 (type 35)))\n"
